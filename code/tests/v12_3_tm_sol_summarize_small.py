...
输入：
- Tm：output/tm_sol_v12_3_small/seqs/<PDB>/arm_*/seqs.fa.tm.csv（temberture_score.py 产物）
...
- output/tm_sol_v12_3_small/tm_sol_summary.json
...
GEN = _PROJECT_DIR / "output/generalization_v12_3_calib_small/protein"
TM_SEQS = _PROJECT_DIR / "output/tm_sol_v12_3_small/seqs"
REF_NATIVE = _PROJECT_DIR / "output/tm_sol_v12_3/ref_native"
UNCOND = _PROJECT_DIR / "output/tm_sol_v12_3/uncond"
OUT_JSON = _PROJECT_DIR / "output/tm_sol_v12_3_small/tm_sol_summary.json"
