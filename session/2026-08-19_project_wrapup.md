...
> 本文件记录 v9 定稿之后的**收尾轮会话**（文档/数据/权重/配置全面整理）。
> 前置状态见 `session/2026-08-16_PROJECT_STATUS.md`（v9 定稿决策记录于 `index/PROJECT_V9_LIGAND_PLAN.md` §八.6）。
...
## 关键决策
1. **v9 定稿，停止训练**（延续上轮）；v7/v9 为最终编码器
